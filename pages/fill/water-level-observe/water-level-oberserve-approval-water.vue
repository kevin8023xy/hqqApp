<template>
    <view class="water-level-observe-approval wh100">
        <!-- 今日填报 -->
        <view class="remain-approval-box">
            <uni-card title="今日水位" :is-shadow="false">
        ...
        <view class="history-fill-box">
            <uni-card title="历史水位" :is-shadow="false">
...
const noticeText = computed(() => {
    ...
    const remainElement = 'xx';
    const status = '待审核';
    return '待审批' + remainApprovalNum + '条，' + remainElement + '管理段尚未提交';
});
