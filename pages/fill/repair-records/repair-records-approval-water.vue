<template>
    <view class="repair-records-approval-water wh100">
        <!-- 今日填报 -->
...
const noticeText = computed(() => {
    ...
    const status = '待审核';
    return '待审批' + remainApprovalNum + '条，今日'+ remainElement + '申请维养';
});
